...
# 2. Create missing index.html to prevent Flask crashes
log "Ensuring templates directory and index.html exist..."
mkdir -p data_engine/templates
touch data_engine/templates/index.html

# 3. Fix frontend event listener and coordinate calculation
...
# 4. Fix backend coordinate transformation
